...
- The old free-form inner voice has been replaced by a structured cognitive prepass: scene appraisal, uncertain user-model hypotheses, response intentions, and observable short-horizon predictions. Adaptive mode uses deterministic compilation for ordinary turns and a timeout-bounded model compiler for socially complex turns plus a stable sample.
